  ...
  return (
    <div style={styles.container}>
      <div style={styles.left}>
        ...
        <p style={styles.tagline}>Join thousands of readers today</p>
        <div style={styles.perks}>
          ...
          <p style={styles.perk}>✅ Cancel anytime</p>
        </div>
      </div>
      <div style={styles.right}>
        <div style={styles.box}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input style={styles.input} type="text" name="name" placeholder="Hamza Khan" value={formData.name} onChange={handleChange} required />
          ...
          <p style={styles.link}>
            Already have an account? <Link to="/login" style={styles.linkBlue}>Login</Link>
          </p>
        </div>
      </div>
    </div>
